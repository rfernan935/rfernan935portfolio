I developed a collection of seven iOS Shortcuts that together function as an interactive hub for a a few classic party games. One shortcut serves as the main hub, while the remaining six act as modular game functions and supporting utilities.
...
[PlayAGameSteps.gif](https://github.com/rfernan935/rfernanportfolio/blob/main/Coding%20Projects/iOS%20Shortcuts/Play-a-Game%20Hub/PlayAGameSteps.gif) walks through the gameplay shortcut. Users choose from a list of available games, then the chosen game’s shortcut is run. After completing a round, users are asked if they'd like to play another game or end the session.
