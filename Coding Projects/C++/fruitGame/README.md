...
### 3. inputAction()
- Prompts the user to enter a movement key (a/A, s/S, d/D, or x/X).
...
- Checks if fruits that were in the second-to-last row (the row above the basket) have been caught or dropped:
