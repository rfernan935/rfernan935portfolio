...
- They enter the number of shares they want to purchase.
- The program verifies the user has enough cash for the purchase.
Once verified:
...
- The user's total cash balance.
- Net worth of the user's portfolio (remaining cash + current total value of stocks).
...
- The program keeps track of the highest and lowest prices each stock has reached.

### 8. Final Report
When the user chooses to quit, the following detailed summary is displayed:

- The user's final cash balance.
- Their total net worth.
- The number of shares owned by the user in each of the unique stocks.
- And each stock’s final value, and highest and lowest recorded prices throughout the simulation.
