# Rebecca Fernandez's Coding and Tech Portfolio
Multidisciplinary professional with a foundation in psychology, neuroscience, and philosophy. Skilled in C++, intermediate robotics, Python, as well as ethical AI and human-centered systems. Creator of Tokenized Morality, a newsletter that translates academic AI ethics into accessible, actionable insight. Known for systems thinking, intellectual precision, and the ability to integrate approachable nuance into technical design.
...
### C++ Projects
Simulator and minigame programs that demonstrate mastery of intermediate C++.
...
A project to light up the correct digit based on the number button pressed, using an Arduino Uno and an IR remote to control a 7-segment display.
...
Custom Shortcuts for iOS designed to streamline daily tasks and automate phone behaviors, as well as to have a bit of fun while showcasing a wide range of Shortcut features.
...
A modular collection of iOS Shortcuts that creates an interactive hub for playing and managing various party games. The system allows users to view game rules, select from multiple games, and customize gameplay based on categories and round count.
...
## Skills  
C++ |  Arduino IDE | Python | Visual Studio | GitHub | Apple Shortcuts | Automation | Object-Oriented Programming
